...
if(isset($_POST['save']))
{
  ...
  $sql="insert into tblproducts(CategoryName,ProductName,ProductPrice,Qty)values(:category,:product,:price,:qty1)";
  ...
  {
    echo '<script>alert("Product name already taken!!!")</script>';
  }
}
if(isset($_GET['del'])){    
  $cmpid=$_GET['del'];
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Add New Product</h5>
              </div>
                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" name="product" pattern="[A-Za-z]+" class="form-control" value="" id="product" placeholder="Enter Product" required>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="form-group col-md-6">
                      <label for="exampleInputName1">Product Price</label>
                      <input type="number" name="price" pattern="^[0-9,]+$"  value="" placeholder="Enter Price" class="form-control" id="price"required>
                    </div>
                  ...
                  <div class="row ">
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" pattern="^[0-9,]+$" name="qty1" value="1" placeholder="Enter Quantity" class="form-control" id="qty1"required>
                    </div>
            ...
            <div class="card">
              ...
              <div class="table-responsive p-3">
                <table class="table align-items-center table-flush table-hover table-bordered" id="dataTableHover">
                  ...
                  <tbody>
                    <?php
                    $sql="SELECT tblproducts.id,tblproducts.CategoryName,tblproducts.ProductName,tblproducts.PostingDate,tblproducts.ProductPrice,tblproducts.Qty from tblproducts ORDER BY id DESC";
                    $query = $dbh -> prepare($sql);
                    $query->execute();
                    $results=$query->fetchAll(PDO::FETCH_OBJ);
                    $cnt=1;
                    if($query->rowCount() > 0)
                    {
                      ...
                      { 
                        ...
                        <tr>
                          ...
                          <td>
                          <a href="#"class=" edit_data5" id="<?php echo  ($row->id); ?>" ><?php  echo htmlentities($row->ProductName);?></a>
                          </td>
                          ...
                          <td class="text-center"><?php  echo htmlentities($row->Qty);?></td>

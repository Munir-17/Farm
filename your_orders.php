            ...
            <section class="restaurants-page">
                <div class="container">
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from invoice where customerID='".$_SESSION['user_id']."' ORDER BY invoiceDate DESC");
              ...
              <tr>
                ...
                <td><a target="_blank" href="bill.php?id='.$row["invoiceID"].'">PDF</a></td>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    ...
                                    <h5>Phone: <a href="tel:+080000012222">0785223742</a></h5> </div>

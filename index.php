...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Looking for animals, specials breed, or rare species?</h5>
                    <br>
                    <br>
                    <br>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Animals</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                          ...
                          <path fill-rule="evenodd" d="M6 1a2.498 2.498 0 0 1 4 0c.818 0 1.545.394 2 1 .67 0 1.552.57 2 1h-2c-.314 0-.611-.15-.8-.4-.274-.365-.71-.6-1.2-.6-.314 0-.611-.15-.8-.4a1.497 1.497 0 0 0-2.4 0c-.189.25-.486.4-.8.4-.507 0-.955.251-1.228.638-.09.13-.194.25-.308.362H3c.13-.147.401-.432.562-.545a1.63 1.63 0 0 0 .393-.393A2.498 2.498 0 0 1 6 1z"/>
                            ...
                            <h4><span>2. </span>Order Animals</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Ready To Be Pickup</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Animals of the Month</h2>
                    <p class="lead">The easiest way to choose</p>
                </div>
                <div class="row">
						...
						<?php 
						// fetch records from database to display popular first 3 animal from table
						$query_res= mysqli_query($db,"select * from animal where animalAvail='0'and police_clearance='CLEARED' LIMIT 3"); 
									      while($r=mysqli_fetch_array($query_res))
										  {
													
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="images/'.$r['animalimg'].'">
																
															
																<div class="review pull-right"> </div>
															</div>
															<div class="content">
																<h5><a href="animal.php?res_id='.$r['breedID'].'">'.$r['animalName'].'</a></h5>
																<div class="product-name">'.$r['slogan'].'</div>
																<div class="price-btn-block"> <span class="price">$'.$r['animalPrice'].'</span> <a href="animal.php?res_id='.$r['breedID'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
															</div>
  ...
  <path d="M14.082 2.182a.5.5 0 0 1 .103.557L8.528 15.467a.5.5 0 0 1-.917-.007L5.57 10.694.803 8.652a.5.5 0 0 1-.006-.916l12.728-5.657a.5.5 0 0 1 .556.103zM2.25 8.184l3.897 1.67a.5.5 0 0 1 .262.263l1.67 3.897L12.743 3.52 2.25 8.184z" fill="#fff"/>
</svg>
                                                 </g>
                                        </svg>
                                    </div>
                                    <h3>Choose a breed</h3>
                                    <p>We"ve got your covered with animal from all over the world breed.</p>
                                </div>
                            </div>
                        </div>
  ...
  <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h9A1.5 1.5 0 0 1 12 3.5V5h1.02a1.5 1.5 0 0 1 1.17.563l1.481 1.85a1.5 1.5 0 0 1 .329.938V10.5a1.5 1.5 0 0 1-1.5 1.5H14a2 2 0 1 1-4 0H5a2 2 0 1 1-3.998-.085A1.5 1.5 0 0 1 0 10.5v-7zm1.294 7.456A1.999 1.999 0 0 1 4.732 11h5.536a2.01 2.01 0 0 1 .732-.732V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5v7a.5.5 0 0 0 .294.456zM12 10a2 2 0 0 1 1.732 1h.768a.5.5 0 0 0 .5-.5V8.35a.5.5 0 0 0-.11-.312l-1.48-1.85A.5.5 0 0 0 13.02 6H12v4zm-9 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm9 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" fill="#fff"/>
</svg>
                                </div>
                                <h3>Pick up or Delivery</h3>
                                <p>Pay online on pickup or delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Easier the checkout by using your Card</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/ONe.jpg" alt="Footer logo"> </a> </div>

...
if(isset($_POST['updatedata']))
{
    ...
    $fname = $_FILES['file']['name'];
                    ...
                    //                     }
                                    ...
                                    // else
                                    //     {
    $que="UPDATE animal SET animalName='$animalName',animalQuantity='$animalQuantity',animalCost='$animalCost' ,animalPrice='$animalPrice',animalDOB='$animalDOB' ,police_clearance='$animalAvail' WHERE animalID='$animalID'";

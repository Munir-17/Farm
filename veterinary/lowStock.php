                            ...
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    ...
                                    <div class="add-product">
                                        <a href="productAdd.php">Add Animal</a>
                                    </div>
                                </div>
                            </div>
                            <div class="sparkline13-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <?php
                                        ...
                                        $display = $con->prepare("SELECT p.*, c.breedName FROM animal AS p LEFT JOIN breed c ON p.breedID=c.breedID where p.animalQuantity<100");
                                        $display->execute();
...
<p  class="textDanger">Non-Available</p>
                                            ...
                                            <td>
                                                <button data-toggle="tooltip" data-target="#book" title="Edit" class="pd-setting-ed editbtn1"><i class="fa fa-pencil-square-o" ></i></button>

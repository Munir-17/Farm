...
if(isset($_POST['save']))
{
  ...
  {
    echo '<script>alert("Category already taken!!!. Please try again")</script>';
  }
}
if(isset($_GET['del'])){    
  $cmpid=$_GET['del'];
                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  <div class="row ">
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" pattern="[A-Za-z]+" name="category" class="form-control" value="" id="category" placeholder="Enter Category" required>
                    </div>
                  </div>
                  <div class="row ">
                    <div class="form-group col-md-6">

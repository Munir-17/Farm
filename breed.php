            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>1</span><a href="breed.php">Choose Breeds</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>2</span><a href="#">Pick Your Animals</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-9">
                            <div class="bg-gray restaurant-entry">
                                <div class="row">
                                <?php $ress= mysqli_query($db,"select * from breed");
                                          while($rows=mysqli_fetch_array($ress))
                                          {
                                                     ...
                                                     echo' <div class="col-sm-12 col-md-12 col-lg-8 text-xs-center text-sm-left">
                                                            <div class="entry-logo">
                                                                <a class="img-fluid" href="animal.php?res_id='.$rows['breedID'].'" > <img src="images/'.$rows['breedName'].'.png" alt="Breed Logo"></a>
                                                            </div>
                                                            <!-- end:Logo -->
                                                            <div class="entry-dscr">
                                                                <h5><a href="animal.php?res_id='.$rows['breedID'].'" >'.$rows['breedName'].'</a></h5>Type: <span>'.$rows['breedType'].' <a href="#"></a></span>
                                                         ...
                                                         <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                                                <div class="right-content bg-white">
                                                                    <div class="right-review">
                                                                        ...
                                                                        <p> </p> <a href="animal.php?res_id='.$rows['breedID'].'" class="btn theme-btn-dash">View Lists</a> </div>
                                                                </div>
                                                                <!-- end:right info -->
                                                            </div>';
                                          }

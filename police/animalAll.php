                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                       ...
                                       <table id="table" data-toggle="table"  data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="price2">Sell Price ($)</th>
                                                <th>Date of birth</th>
                                                <th>Age year(s)</th>
                                                <th data-field="img">Images</th>
                                                <th data-field="avail">Police Clearance</th>
                                                <th>Action</th>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php if($row['police_clearance'] == "CLEARED"): ?>
                                                    <p  class="textSuccess">CLEARED</p>
                   
                                            <?php elseif ($row['police_clearance'] == "NOT-CLEARED"): ?>
                                            <p  class="textDanger">NOT-CLEARED</p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form group">
            ...
            <input  type="text" id="animalAvail" class="form-control" readonly><br>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('.editbtn1').on('click', function() {
            ...
            var clearance =  $('#animalAvail').val();
            clearance = clearance.trim()
            if(clearance == 'NOT-CLEARED'){
                $('#animalAvail').css('background-color','red')
                var selector = `<div class="alert alert-warning text text-dark col-lg-12 "> <b>CHOOSE</b> the availibility below <b>if want to update the details</b> :</div><br>
...
<option value="NOT-CLEARED"selected>Not Cleared</option>
   <option value="CLEARED" >Clear Livestock</option>
</select>`
            $('.modal-body').append(selector)
            }else{
                $('#animalAvail').css('background-color','#9CFF88')
            }

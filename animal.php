...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="breed.php">Choose Breeds</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="animal.php?res_id=<?php echo $_GET['breedID']; ?>">Pick Your Animals</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from breed where breedID='$_GET[res_id]'");
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    <h6><a href="#"><?php echo $rows['breedName']; ?></a></h6>
                                    <p><?php echo $rows['breedType']; ?></p>
...
?>									
                                        ...
                                        <div class="title-row">
										<?php echo $item["animalName"]; ?><a href="animal.php?res_id=<?php echo $_GET['res_id']; ?>&action=remove&id=<?php echo $item["animalID"]; ?>" >
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill pull-right" viewBox="0 0 16 16">
                                        ...
                                        <div class="form-group row no-gutter">
                                            ...
                                            <div class="col-xs-4">
                                                <input type="number" id="quantity"value='<?php echo $item["quantity"]; ?>' name="quantity" min="1" max="<?php echo $item['animalQuantity']; ?>" id="example-number-input"> </div>
                                        
									  </div>
									  
	<?php
$item_total += ($item["animalPrice"]*$item["quantity"]); // calculating current price into cart
}
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill pull-right" viewBox="0 0 16 16">
                              <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
                            </svg>
                              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-down-fill pull-right" viewBox="0 0 16 16">
						...
						<?php  // display values and item of animal
									$stmt = $db->prepare("select * from animal where police_clearance='CLEARED' AND breedID='$_GET[res_id]'");
									$stmt->execute();
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<form method="post" action='animal.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['animalID']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="images/'.$product['animalimg'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
                                            <div class="rest-descr">
                                                <h6><a href="#"><?php echo $product['animalName']; ?></a></h6>
                                               </h5>Quantity: <span><?php echo $product['animalQuantity']; ?> lefts</span>
										...
										<span class="price pull-left" >$ <?php echo $product['animalPrice']; ?></span>
										  <input type="number" id="quantity" value="1" name="quantity" min="1" max="<?php echo $product['animalQuantity']; ?>" ><br><br>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <h5>Phone: <a href="tel:+2637887942">0785223742</a></h5> </div>
